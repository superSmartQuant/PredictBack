...
class PolymarketRepository:
    ...
    def register_market(
        ...
        with self.get_connection() as conn:
            with conn.cursor() as cur:
                cur.execute(
                    """
                    INSERT INTO hist_markets (clob_token_id, question, market_slug, neg, topic_id)
                    VALUES (%s, %s, %s, %s, %s)
                    ...
                    """,
                    (clob_token_id, question, market_slug, neg, topic_id),
                )
    ...
    def add_market(
        ...
        self.register_market(clob_token_id, question, market_slug, neg, topic)
        return table_name
